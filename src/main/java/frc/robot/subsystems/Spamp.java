...
public class Spamp extends SubsystemBase {
    ...
    private boolean readyToShootIndicator;
    ...
    */
    ...
    public void clearShootIndicator() {
        readyToShootIndicator = false;
        m_time.stop();
    }

    public boolean isReadyToShoot() {
        if (m_time.hasElapsed(2) ) {
            readyToShootIndicator = true;
        }
        return readyToShootIndicator;
    }
