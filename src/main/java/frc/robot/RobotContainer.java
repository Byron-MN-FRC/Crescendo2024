...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    accessory.leftTrigger(0.5)
      ...
      new Pose2d(2.15, 6.0, Rotation2d.fromDegrees(180)), 
      new PathConstraints(
        4.0, 4.0, 
    ...
    SmartDashboard.putData("Pathfind to Amp Pos", AutoBuilder.pathfindToPose(
      new Pose2d(1.90,7.75, Rotation2d.fromDegrees(-90)), 
      new PathConstraints(
        2.0, 2.0, 
        Units.degreesToRadians(360), Units.degreesToRadians(540)
      ), 
      0, 
      2.0
    ).andThen(new autonAmp(m_spamp)));    // Add a button to SmartDashboard that will create and follow an on-the-fly path
